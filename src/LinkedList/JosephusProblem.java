...
public class JosephusProblem {
    public static void main(String[] args) {
        System.out.println(findJosephus(7,3));
    }

    private static int findJosephus(int n, int k) {
        ListNode<Integer> temp = ListNode.getIntegerCircularList(n);
        boolean last =false ;
        ...
        do {
            for (int i = 0; i < k; i++) {
                ...
                if (prev!=null && prev.getNext() == prev.getNext().getNext()) {
                    last = true;
                    break;
                }
                prev =temp ;
